...
#
# @within	_your_namespace:custom_blocks/steel_block/place_main
#
...
# Add a custom name
data merge entity @s {CustomName: {"translate": "_your_namespace.steel_block", italic: false, color: "white"}}
