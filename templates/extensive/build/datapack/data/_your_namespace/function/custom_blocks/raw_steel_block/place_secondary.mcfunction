...
#
# @within	_your_namespace:custom_blocks/raw_steel_block/place_main [ align xyz & positioned ~0.5 ~0.5 ~0.5 & at @s ]
#
...
# Add a custom name
data merge entity @s {CustomName: {"translate": "_your_namespace.raw_steel_block"}}
