...
#> _your_namespace:custom_blocks/deepslate_steel_ore/replace_item
#
# @executed	 as @n[type=item,nbt={...},distance=..1] 
#
# @within	_your_namespace:custom_blocks/deepslate_steel_ore/destroy [ as @n[type=item,nbt={...},distance=..1] ]
#

# If silk touch applied
execute if score #is_silk_touch _your_namespace.data matches 1 run data modify entity @s Item.id set from storage _your_namespace:items all.deepslate_steel_ore.id
execute if score #is_silk_touch _your_namespace.data matches 1 run data modify entity @s Item.components set from storage _your_namespace:items all.deepslate_steel_ore.components
